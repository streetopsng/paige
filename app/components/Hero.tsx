    ...
    <section className="hero-bg" style={{ paddingTop: 80, paddingBottom: 0 }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ textAlign: "center", paddingTop: 80, paddingBottom: 64, maxWidth: 860, margin: "0 auto" }}>
          ...
          <h1 className={`fade-up fade-up-1 ${tc}`} style={{ fontFamily: "DM Sans,sans-serif", fontWeight: 900, fontSize: "clamp(40px, 6vw, 72px)", lineHeight: 1.08, margin: "0 0 24px", letterSpacing: "-0.03em" }}>
            Team engagement<br />
            <span style={{ color: "var(--yellow)" }}>you can count on.</span>
          </h1>
          ...
          <div className="fade-up fade-up-4" style={{ display: "flex", flexWrap: "wrap", gap: "8px 24px", justifyContent: "center" }}>
            {["No credit card required","2-minute team setup","GDPR compliant"].map((pt) => (
              <span key={pt} className={ts} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 500 }}>
                <CheckCircle size={13} style={{ color: "var(--yellow)" }} /> {pt}
              </span>
            ))}
          </div>
        </div>
        ...
        <div style={{ padding: "60px 0 0", borderTop: "1px solid var(--border-dark)", marginTop: 64 }}>
          <p style={{ textAlign: "center", fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.12em", color: "var(--white)", marginBottom: 28 }}>
          ...
          <div style={{ overflow: "hidden", maskImage: "linear-gradient(90deg, transparent, black 10%, black 90%, transparent)" }}>
            <div className="marquee-track">
              {[...logos, ...logos].map((l, i) => (
                <span key={i} style={{ fontSize: 14, fontWeight: 700, fontFamily: "DM Sans,sans-serif", color: "var(--white)", letterSpacing: "0.04em", whiteSpace: "nowrap", opacity: 0.6 }}>{l}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div id="about" style={{ padding: "80px 0" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 className={tc} style={{ fontFamily: "DM Sans,sans-serif", fontWeight: 800, fontSize: "clamp(28px, 4vw, 42px)", margin: 0, letterSpacing: "-0.02em" }}>
