...
const ReadyToTakeControl = () => {
  return (
    <section className=" px-2 py-20 md:px-8  relative bg-primary">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem]  text-center text-foreground  md:px-10 ">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 flex justify-center">
            <Button
              ...
              className="h-11 cursor-pointer rounded-lg bg-white px-6 font-body text-sm font-semibold text-primary"
            >
              Get early access
